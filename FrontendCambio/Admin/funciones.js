...
function cargarPacientes(){
    let file = document.getElementById("cargaPacientes").files[0];
    if (file) {
        ...
        reader.onload = function (evt) {
            ...
            fetch('http://130.211.213.9:5000/cargaNueva/1', {
            method: 'POST',
            headers,
...
function cargarEnfermeros(){
    let file = document.getElementById("cargaEnfermeros").files[0];
    if (file) {
        let reader = new FileReader();
        reader.readAsText(file, "UTF-8");
        reader.onload = function (evt) {
            ...
            console.log(JSON.stringify(cuerpo))
            fetch('http://130.211.213.9:5000/cargaNueva/2', {
            method: 'POST',
            headers,
            body: JSON.stringify(cuerpo),
            })
...
function cargarDoctores(){
    let file = document.getElementById("cargaDoctores").files[0];
    if (file) {
        let reader = new FileReader();
        reader.readAsText(file, "UTF-8");
        reader.onload = function (evt) {
            ...
            console.log(JSON.stringify(cuerpo))
            fetch('http://130.211.213.9:5000/cargaNuevaDoctores/3', {
            method: 'POST',
            headers,
            body: JSON.stringify(cuerpo),
            })
...
function cargarMedicinas(){
    let file = document.getElementById("cargaMedicinas").files[0];
    if (file) {
        let reader = new FileReader();
        reader.readAsText(file, "UTF-8");
        reader.onload = function (evt) {
            ...
            console.log(JSON.stringify(cuerpo))
            fetch('http://130.211.213.9:5000/cargaMedicinasNueva', {
            method: 'POST',
            headers,
            body: JSON.stringify(cuerpo),
            })
...
function actualizar()
{
    document.getElementById("cardscCAMBIO").innerHTML='';
    let text=""
    ...
    .then(data=>
        ...
        document.getElementById("cardscCAMBIO").innerHTML=text;
    });
}
