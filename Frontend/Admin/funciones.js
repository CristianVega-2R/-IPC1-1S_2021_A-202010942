...
function cargarPacientes(){
    ...
    if (file) {
        ...
        reader.onload = function (evt) {
            ...
            fetch('http://localhost:5000/cargaNueva/1', {
            method: 'POST',
            headers,
...
function cargarEnfermeros(){
    ...
    if (file) {
        ...
        reader.onload = function (evt) {
            ...
            console.log(JSON.stringify(cuerpo))
            fetch('http://localhost:5000/cargaNueva/2', {
            method: 'POST',
            headers,
            body: JSON.stringify(cuerpo),
            })
...
function cargarDoctores(){
    ...
    if (file) {
        ...
        reader.onload = function (evt) {
            ...
            console.log(JSON.stringify(cuerpo))
            fetch('http://localhost:5000/cargaNuevaDoctores/3', {
            method: 'POST',
            headers,
            body: JSON.stringify(cuerpo),
            })
...
function cargarMedicinas(){
    ...
    if (file) {
        ...
        reader.onload = function (evt) {
            ...
            console.log(JSON.stringify(cuerpo))
            fetch('http://localhost:5000/cargaMedicinasNueva', {
            method: 'POST',
            headers,
            body: JSON.stringify(cuerpo),
            })
